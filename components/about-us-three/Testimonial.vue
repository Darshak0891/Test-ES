<template>
  <section>
    <div class="testimonial-area-6 gap-bottom-equal">
        ...
        <div class="row row--40">
          <div class="col-lg-6">
            ...
            <div class="about-3-testimonial-wrapper">
              <swiper
                class="testimonial-activation-5 swiper"
                :modules="modules"
                :slidesPerView="1"
                :loop="true"
                :spaceBetween="0"
                  ...
                  <div class="testimonial-slide testimonial-style-3">
                    <div class="content">
                      ...
                      <p>
                        ...
                        do umod tempor ux incididunt enim ad minim veniam quis
                        sit nosrud citation laboris nisiste aliquip comodo
                        perspiatix une omnis iste natus error sit voluptatem
                        accusantium dolore que laudantum”.
                      </p>
          ...
          <div class="col-lg-6">
            <div
              class="video-gallery video-gallery-5"
              data-aos-delay="150"
              data-aos="fade-left"
