      ...
      <div class="header-top">
        ...
        <div class="header-top-right">
          <ul class="header-info">
            <!-- <li><NuxtLink to="/my-account">Login</NuxtLink></li>
                        <li><NuxtLink to="/my-account">Register</NuxtLink></li> -->
            <li>
              <a href="tel:+011235641231"
                ><i class="icon-phone"></i>Call: 123 4561 5523</a
              >
            </li>
            <li>
              <a href="mailto:info@edublink.com" target="_blank"
                ><i class="icon-envelope"></i>Email: info@edublink.com</a
              >
            </li>
