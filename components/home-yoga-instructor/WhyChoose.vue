<template>
  <div class="why-choose-area-1 gap-top-text">
    <div class="container">
      <div class="row g-5 row--45">
        <div class="col-lg-6">
          <div class="why-choose-content">
            <SectionTitle
              ...
              title="Why Choose Empire Surveillance?"
        ...
        <div class="col-lg-6">
          <div class="why-choose-gallery">
            <div class="gallery-thumbnail">
              <div class="thumbnail thumbnail-1">
                <img src="/images/others/why-choose-01.webp" alt="Why Choose" />
              </div>
              <div
                class="thumbnail thumbnail-2 rellax"
                data-rellax-speed="0.7"
                data-rellax-xs-speed="0.7"
                data-rellax-mobile-speed="0.5"
                data-rellax-tablet-speed="0.5"
              >
                <img src="/images/others/why-choose-02.webp" alt="Why Choose" />
              </div>
            </div>
            <ul class="shape-group">
              ...
              >
                <img src="/images/about/shape-14.png" alt="Shape Images" />
              </li>
              <li
                class="shape-2"
                data-aos-delay="500"
                ...
                data-aos-duration="200"
              >
                <img src="/images/about/shape-10.png" alt="Shape Images" />
              </li>
            </ul>
          </div>
        </div>
    ...
    return {
      features: [
        ...
        },
        {
          ...
          details:
            "Consectetur adipisicing elit, sed do eiusmod tempor ux incididunt ut labore et dolore.",
        },
        {
