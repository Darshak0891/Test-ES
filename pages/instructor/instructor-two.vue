<template>
  <div id="main-wrapper" class="main-wrapper">
    ...
    <BreadCrumbOne pageTitle="Our Team" title="Leadership Instruction" />

    <div class="edu-team-area team-area-1 gap-tb-text">
      <div class="container">
        <SectionTitle title="Team Members" alignment="section-center" />

        <div class="row g-5">
          <div
            class="col-lg-3 col-sm-6 col-12 mb--10"
            data-aos-delay="150"
            data-aos="fade-up"
            data-aos-duration="800"
            v-for="(instructor, key) in instructors.slice(0, 8)"
            :key="key"
          >
...
import InstructorOne from "~~/components/instructor/InstructorOne.vue";
